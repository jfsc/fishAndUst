...
//  public static final String RESULT_PATH = "RESULT_PATH";
    ...
    public Intent createFileDialogIntent(Activity activity) {
    	...
    	return createDialogIntent(activity, intent);
    }
    
    public Intent createFolderDialogIntent(Activity activity) {
    	Intent intent = new Intent(activity.getBaseContext(), FolderDialog.class);
    	return createDialogIntent(activity, intent);
    }
    
    protected Intent createDialogIntent(Activity activity, Intent intent) {
     ...
     */
    public static String readResultFileName(Intent intent) {
        return intent != null ? intent.getStringExtra(RESULT_FILE) : null;
    }
    ...
    public static long readResultFileLength(String filePath)
    {
